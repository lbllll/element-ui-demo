...
<template>
  <div class="bodyBox" id>
    <el-table :data="tableData" border :header-cell-style="{background:'#afafaf',color:'#606266'}">
      ...
      <el-table-column label="文章标题" width="400" prop="title" align="center"></el-table-column>
      <el-table-column label="标签" width="300" prop="labels" align="center"></el-table-column>
      ...
      <el-table-column label="副标题" width="400" prop="description" align="center"></el-table-column>
      ...
      <el-table-column label="商户id" width="100" prop="memberId" align="center"></el-table-column>
    </el-table>
    <el-pagination
